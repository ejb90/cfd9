...
def write_notes(path: Path, config: CaseConfig) -> None:
    ...
    lines = [
        ...
        f"- Pre-shock ambient: rho = {config.shock.rho1:.8g} kg/m3, p = {config.shock.p1:.8g} Pa, u = 0 m/s.",
        f"- Post-shock ambient: rho = {config.shock.rho2:.8g} kg/m3, p = {config.shock.p2:.8g} Pa, u = {config.shock.u2:.8g} m/s.",
