...
# TT09 figure 5 models its upper half by symmetry.
...
def parse_args() -> argparse.Namespace:
    ...
    # TT09 section 4.1.1's 40/80/160 cells-per-diameter refinement range is
    # adopted for this companion case; 100 is the default validation mesh.
