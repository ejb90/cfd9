...
The x-domain has documented upstream/downstream padding relative to the paper
so the established cell-doubling suite retains approximately square cells. The
bubble diameter, shock gap, half-domain height, physical states, and interaction
time are unchanged.
